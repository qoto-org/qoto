...
ActiveRecord::Schema.define(version: 2022_03_07_083603) do
  ...
  create_table "accounts", id: :bigint, default: -> { "timestamp_id('accounts'::text)" }, force: :cascade do |t|
    ...
    t.index ["url"], name: "index_accounts_on_url", where: "(url IS NOT NULL)"
  end
  ...
  create_table "conversations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["uri"], name: "index_conversations_on_uri", unique: true, where: "(uri IS NOT NULL)"
  end
  ...
  create_table "media_attachments", id: :bigint, default: -> { "timestamp_id('media_attachments'::text)" }, force: :cascade do |t|
    ...
    t.index ["shortcode"], name: "index_media_attachments_on_shortcode", unique: true, where: "(shortcode IS NOT NULL)"
  ...
  create_table "statuses", id: :bigint, default: -> { "timestamp_id('statuses'::text)" }, force: :cascade do |t|
    ...
    t.index ["uri"], name: "index_statuses_on_uri", unique: true, where: "(uri IS NOT NULL)"
  end
