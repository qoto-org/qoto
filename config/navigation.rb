...
SimpleNavigation::Configuration.run do |navigation|
  navigation.items do |n|
    ...
    n.item :trends, safe_join([fa_icon('fire fw'), t('admin.trends.title')]), admin_trends_tags_path, if: proc { current_user.can?(:manage_taxonomies) } do |s|
    ...
    n.item :moderation, safe_join([fa_icon('gavel fw'), t('moderation.title')]), admin_reports_url, if: proc { current_user.can?(:manage_reports) } do |s|
