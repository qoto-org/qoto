...
class Web::PushSubscription < ApplicationRecord
  ...
  def audience
    @audience ||= Addressable::URI.parse(@subscription.endpoint).normalized_site
  end

  def authorization_header
    jwt       = JWT.encode({ aud: audience, exp: 24.hours.from_now.to_i, sub: ::Setting.site_contact_email }, vapid_key.curve, 'ES256', typ: 'JWT', alg: 'ES256')
