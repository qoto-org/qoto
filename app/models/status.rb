...
class Status < ApplicationRecord
  ...
  has_one :trending_status, foreign_key: :id, class_name: 'Trends::TrendingStatus'
  has_one :filtered_trending_status, foreign_key: :id, class_name: 'Trends::FilteredTrendingStatus'
